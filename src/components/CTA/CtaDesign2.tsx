...
const CtaDesign2: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-3 space-x-4 mt-4">
        <div className="max-w-7xl h-1/3 p-5 bg-orange-800 text-white flex flex-col justify-center items-center">
