...
const TableDesign2: React.FC = () => {
  const [copied, setCopied] = useState(false);

	const buttonCode = `
		<div className="flex justify-center">
			<div className="w-full max-w-4xl bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
				<div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
					<h2 className="text-lg font-semibold text-gray-700 dark:text-gray-100">Table</h2>
					<div>
						<input
							type="text"
							placeholder="Search"
						...
						<tbody className="divide-y divide-gray-200">
							<tr className="transition-colors">
								<td className="px-6 py-4 text-gray-700">
									<p className="text-sm font-medium dark:text-gray-100">John Doe</p>
								</td>
								<td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-100">
									john.doe@example.com
								</td>
								<td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-100">Admin</td>
								<td className="px-6 py-4 text-center space-x-2">
									<button className="px-4 py-1 text-nowrap font-semibold bg-gray-800 text-white rounded-md dark:border hover:bg-gray-900 transition-colors">
										Edit
									</button>
