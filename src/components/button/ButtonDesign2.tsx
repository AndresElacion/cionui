...
const ButtonDesign2: React.FC = () => {
  const [copied, setCopied] = useState(false);

  const buttonCode = `
    <button className="px-4 py-1 text-nowrap font-semibold bg-gray-300 
        text-gray-800 rounded-md hover:bg-gray-400 transition-colors">
        Secondary
    </button>
  `;
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col justify-center items-center space-y-3 space-x-4 mt-4">
      <button className="px-4 py-1 text-nowrap font-semibold bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400 transition-colors">
        Button
      </button>
