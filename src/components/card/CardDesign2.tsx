  ...
  const buttonCode = `
    <div className="max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-lg  shadow-md overflow-hidden">
        ...
        <div className="p-4">
            ...
            {/* Card Button */}
            <button className="px-4 py-1 text-nowrap font-semibold bg-gray-800 text-white hover:bg-gray-950 dark:text-gray-800 dark:bg-gray-300 hover:dark:bg-gray-100 rounded-md transition-colors">
                Primary
            </button>
        </div>
    </div>
