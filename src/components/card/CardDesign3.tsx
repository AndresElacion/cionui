...
const CardDesign3: React.FC = () => {
  ...
  const buttonCode = `
    <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md
        ...
        {/* Card Image */}
        <img
            className="w-full h-48 object-cover hover:scale-[105%] ease-out
                transition duration-300 rounded-xl shadow-md"
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col justify-center items-center space-y-3 space-x-4 mt-4">
      <div className="flex flex-row max-w-2xl bg-white rounded-lg shadow-md overflow-hidden">
        {/* Card Image */}
        <img
          className="w-full h-48 object-cover hover:scale-[105%] ease-out transition duration-300 rounded-xl shadow-md"
          src="https://via.placeholder.com/400x300"
          alt="Placeholder"
        />
