  ...
  const copyCodeToClipboard = () => {
	...
	return (
		<div className="flex flex-col justify-center items-center space-y-3 space-x-4 mt-4">
			<div className="max-w-7xl bg-cover bg-center bg-no-repeat text-white flex flex-col justify-center items-center" style={{ backgroundImage: 'url("https://via.placeholder.com/1920x1080")' }}>
