...
const AxiosComponent: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col justify-center items-center space-y-3 space-x-4 mt-4">
      <h1 className="text-2xl font-bold dark:text-gray-100">Axios Component</h1>
      <p className="text-gray-600 dark:text-gray-100">This component sets up Axios for use in your React Laravel project.</p>
      <p className="text-gray-600 dark:text-gray-100">Create a axios.ts file inside src folder</p>
